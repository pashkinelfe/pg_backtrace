...
### specify minimum exception or error level for stack trace to be dumped into the log using GUC:
...
### Determine the current state of stuck backend (e.g some long running query you do not know where it spends most of time)
